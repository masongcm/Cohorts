...
read_chunk(here("codes/R/5_graphs_ineq.R"))
read_chunk(here("codes/R/5_graphs_item.R"))
...
\begin{figure}
<<RAWHIST, dependson="FA_SCORES_BIND", dev='tikz', fig.height=10, fig.width=10, out.width='\\linewidth'>>=
@
\caption{Sum scores}
...
\begin{figure}
<<FACINEQ_SM, dependson="FA_SCORES_BIND", dev='tikz', fig.height=9, fig.width=10, out.width='\\linewidth'>>=
...
\begin{figure}
<<ITEMINEQ_PS, dependson="FA_SCORES_BIND", dev='tikz', fig.height=8, fig.width=12, out.width='\\linewidth'>>=
itempl_ps
@
...
\begin{figure}
<<ITEMINEQ_FSC, dependson="FA_SCORES_BIND", dev='tikz', fig.height=8, fig.width=12, out.width='\\linewidth'>>=
itempl_fsc
@
...
\begin{figure}
<<ITEMINEQ_SM, dependson="FA_SCORES_BIND", dev='tikz', fig.height=8, fig.width=12, out.width='\\linewidth'>>=
itempl_sm
@
...
\begin{table}
\centering\footnotesize
\caption{Predictors of adolescent and adult outcomes -- BCS}
<<REGS_OUTC_BCS, results='asis', dependson="REGS_OUTC">>=

# collapse to matrix
bcs_outctab_mat <- do.call(rbind,lapply(bcs_outctab[c("smktry16", "bmi16", "hnvq30", "lhgrpay38")],matrix,ncol=9,byrow=FALSE))
...
\begin{table}
\centering\footnotesize
\caption{Predictors of adolescent outcomes -- MCS}
<<REGS_OUTC_MCS, results='asis', dependson="REGS_OUTC">>=

# collapse to matrix
mcs_outctab_mat <- do.call(rbind,lapply(mcs_outctab[c("smktry14", "bmi14")],matrix,ncol=9,byrow=FALSE))
table <- mcs_outctab_mat
printoutctab(table, 2)
