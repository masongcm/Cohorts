...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \clearpage
% THIS BREAKS THE CACHING FOR SOME REASON
% <<IQRDEC_FUN>>=
% # load functions
% @
% 
% <<IQRDEC, dependson="FA_SCORES_MAIN">>=
% # decompose
% @
% 
% % Compare inequality statistics of original vs residualised scores
% % <<IQRDEC_RES, dependson='IQRDEC', echo=T, results='markup'>>=
% % iqs.orig
% % iqs.resid
% % @
...
cfp.ext
@
\caption{Counterfactual decomposition -- externalising skills}\label{fig:counterf}
...
cfp.int
@
\caption{Counterfactual decomposition -- internalising skills}\label{fig:counterf}
{\scriptsize \emph{Notes}: \par}
\end{figure}
\end{landscape}
